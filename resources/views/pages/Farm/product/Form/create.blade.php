    ...
    <div class=" ">  
        <div class="box">
            <div class="box-header b-b" >
                <b><h3 class="text-center"> Inserção de novo produto </h3></b> 
            </div>
            <div class="box-body">
                <form id="form" name="form" action="{{ route('farmacia_produtos.store') }}" method="POST" enctype="multipart/form-data">
                  @method('POST')
                  @csrf
                    <div class="row">
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="info_pro" id="info_pro" cols="30" rows="3" maxlength="191" class=" py-3 form-control"></textarea>
